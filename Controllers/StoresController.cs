...
namespace WebApplicationCarDealershipFinalExamPrep.Controllers
{
    public class StoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StoreID,Name,Description")] Store store)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StoreID,Name,Description")] Store store)
        {
            if (id != store.StoreID)
            {
                return NotFound();
