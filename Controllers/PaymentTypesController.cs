...
namespace WebApplicationCarDealershipFinalExamPrep.Controllers
{
    public class PaymentTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentTypeID,CardType")] PaymentType paymentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentTypeID,CardType")] PaymentType paymentType)
        {
